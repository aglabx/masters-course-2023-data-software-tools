...
В рамках курса предполагается выполнение 8 домашних работ в командах их двух человек. Максимальный бал за каждую работу 10 баллов. За просрочку здачи задания начисляется штраф 1 балл от полученных баллов за каждую неделю просрочки. Дополнительные балы можно получить за peer-review работ других команд.

Каждая домашняя работа должна быть сдана в следующую неделю за прослушиванием соответствующей лекции. Сдача, peer-review и проверка работы осуществляется через бота в телеграме.
...
Экзамен в виде теста. Оценка состоит из двух часте 80% из практических заданий, 8 заданий по 10 баллов, 20% экзамен в виде теста с максимальными 20 баллами.
